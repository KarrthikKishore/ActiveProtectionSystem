...
MQTT_SERVER = "192.168.217.62"
MQTT_PATH = "test_channel"
import time

def mqtt(a,b):

    cordinates=bytearray([int(a/2.48),int(b/5)])
    publish.single(MQTT_PATH, cordinates , hostname=MQTT_SERVER) #send data continuously every 1 seconds
